class MulleClangProject < Formula
  ...
  version "22.1.2.0"
#  revision 1
  head "https://github.com/mulle-cc/mulle-clang-project.git", branch: "mulle/22.1.2"

#
# MEMO:
#    0. Replace 22.1.2.0 with x.0.0.0 your version number (and check vendor)
#    1. Create a release on github
#    2. Download the tar.gz file from github like so
#       `curl -O -L "https://github.com/mulle-cc/mulle-clang-project/archive/22.1.2.0.tar.gz"`
#    3. Run shasum over it `shasum -a 256 -b 22.1.2.0.tar.gz`
#    4. Remove bottle urls
#
  url "https://github.com/mulle-cc/mulle-clang-project/archive/refs/tags/22.1.2.0.tar.gz"
  sha256 "04f062730101b17c3a90954832321cfbcd035938fb9ab87ff4e6ac9bee5a5a0b"

  def vendor
    "mulle-clang 22.1.2.0 (runtime-load-version: 19)"
  end
...
#    `mv ./mulle-clang--22.1.2.0.bigsur.bottle.tar.gz  ./mulle-clang-project-22.1.2.0.bigsur.bottle.tar.gz`
#
#     scp -i ~/.ssh/id_rsa_hetzner_pw \
#            ./mulle-clang-22.1.2.0.bigsur.bottle.tar.gz \
#            codeon@www262.your-server.de:public_html/_site/bottles/
#
  bottle do
    root_url "https://github.com/mulle-cc/mulle-clang-project/releases/download/22.1.2.0"
    sha256 cellar: :any_skip_relocation, big_sur: "b8d3cb6ed0aff528cf032f94a88ff4f263252621dcb931916851dae75ef60e7b"
  end
...
#
  ...
  def install
    mkdir "build" do
      ...
      args << "-DLLVM_ENABLE_PROJECTS='clang'" # ";compiler-rt'" don't build for now on bigsur
